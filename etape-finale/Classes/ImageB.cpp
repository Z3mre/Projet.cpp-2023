...
{
#ifdef DEBUG
    cout << ">>> ImageB : constructeur d'initialisation 1<<<" << endl;  
#endif
...
{
#ifdef DEBUG
    cout << ">>> ImageB : constructeur d'initialisation 2 <<<" << endl;  
#endif
...
ImageB::ImageB(const char* f) : Image(f)
{
    #ifdef DEBUG
    cout << ">>> ImageB : constructeur  <<<" << endl;
    #endif
